...
public class UrlImageGetter implements ImageGetter {
    ...
    public class ImageGetterAsyncTask extends AsyncTask<String, Void, Drawable> {
        ...
        protected Drawable doInBackground(String... params) {
            ...
            Bitmap bitmap = ImageCacheManager.getInstance().getBitmap(source);
            if (bitmap != null) {
                Log.i(getClass().getSimpleName(), source);
                return new BitmapDrawable(c.getResources(), bitmap);
            } else {
                Drawable drawable = fetchDrawable(source);
                ImageCacheManager.getInstance().putBitmap(source, ((BitmapDrawable) drawable).getBitmap());
                return drawable;
            }
        ...
        public Drawable fetchDrawable(String urlString) {
            ...
            try {
                ...
                Log.i(getClass().getSimpleName(), drawable.getIntrinsicWidth() + "/" + drawable.getIntrinsicHeight());
